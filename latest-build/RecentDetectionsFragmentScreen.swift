    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                Text("RecentDetectionsFragment").font(.title2).bold().padding(.bottom)
                Button(action: {}) {
                ...
                NavigationLink(destination: FreezeReflexScreen()) {
                    HStack { Text("🚨 FREEZEREFLEX: "); Spacer(); Image(systemName: "arrow.right.circle.fill") }
                    .padding().background(Color.green.opacity(0.1)).cornerRadius(8)
                }
                Button(action: {}) {
                ...
                Button(action: {}) {
                    HStack { Text("Unable to delete: not authenticated"); Spacer(); Image(systemName: "chevron.right.circle") }
                    .padding().background(Color.blue.opacity(0.1)).cornerRadius(8)
                }
                Button(action: {}) {
                    HStack { Text("Alert deleted"); Spacer(); Image(systemName: "chevron.right.circle") }
                    .padding().background(Color.blue.opacity(0.1)).cornerRadius(8)
                }
                Button(action: {}) {
                    HStack { Text("RecentDetections"); Spacer(); Image(systemName: "chevron.right.circle") }
