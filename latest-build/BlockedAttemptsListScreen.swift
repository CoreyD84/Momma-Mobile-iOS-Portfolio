...
struct BlockedAttemptsListScreen: View {
    @EnvironmentObject var container: AppDependencyContainer
    @StateObject private var viewModel: BlockedAttemptsListViewModel

    init(viewModel: BlockedAttemptsListViewModel? = nil) {
        _viewModel = StateObject(wrappedValue: viewModel ?? BlockedAttemptsListViewModel())
    }
