...
struct EliminationScreenKtScreen: View {
    @StateObject private var viewModel = EliminationScreenKtViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            Text("Method not decompiled: com.soullink.app.ui.screens.elimination.EliminationScreenKt.ErrorScreen(java.lang.String, kotlin.jvm.functions.Function0, androidx.compose.runtime.Composer, int):void")
                .navigationTitle("EliminationScreenKt")
        }
        .onAppear { viewModel.onEvent(EliminationScreenKtEvent.onAppear) }
    }
}
