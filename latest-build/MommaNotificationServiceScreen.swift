    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                ...
                Text("✅ FreezeReflex activation notification sent").font(.subheadline).foregroundColor(.secondary)
                Button(action: {}) {
                    HStack {
                        Text("open_tab")
                        Spacer()
                ...
                Text("✅ Blocked attempt notification sent").font(.subheadline).foregroundColor(.secondary)
                Button(action: {}) {
                    HStack {
                        Text("critical")
                        Spacer()
                ...
                Text("✅ Threat detected notification sent").font(.subheadline).foregroundColor(.secondary)
                Button(action: {}) {
                    HStack {
                        Text("critical")
                        Spacer()
                ...
                Text("Medium-priority threats and detections").font(.subheadline).foregroundColor(.secondary)
                Button(action: {}) {
                    HStack {
                        Text("Information")
                        Spacer()
