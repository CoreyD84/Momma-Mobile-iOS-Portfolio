...
protocol LocationService {
    ...
    func getCurrentLocation() -> Result<Any, Error>
    func getAddressFromCoordinates(latitude: Double, longitude: Double) -> Address
    func calculateDistance(location1: Any, location2: Any) -> Double
    func isWithinDistance(location1: Any, location2: Any, maxDistanceMiles: Int) -> Bool
...
class LocationServiceImpl: LocationService {
    ...
    func getCurrentLocation() -> Result<Any, Error> { return .failure(NSError(domain: "LocationService", code: 0)) } 
    func getAddressFromCoordinates(latitude: Double, longitude: Double) -> Address { fatalError("Stub") } 
    func calculateDistance(location1: Any, location2: Any) -> Double { return 0 } 
    func isWithinDistance(location1: Any, location2: Any, maxDistanceMiles: Int) -> Bool { return false } 
