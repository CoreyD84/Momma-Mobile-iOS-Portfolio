...
@MainActor
final class FreezeReflexSettingsViewModel: ObservableObject {
    @Published var showFilePicker: Bool = false
    @Published var engineStatus: String = "Ready"
    @Published var lastCiphertext: String = ""
    @Published var isInitialized: Bool = false
    @Published var freezeReflexEnabled: String = ""
    @Published var autoTakeoverEnabled: String = ""
    @Published var notificationsEnabled: String = ""
