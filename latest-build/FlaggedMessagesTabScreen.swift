import SwiftUI
struct FlaggedMessagesTabScreen: View { var body: some View { VStack(spacing: 15) {
            Text("FlaggedMessagesTab").font(.headline)
            ...
            Spacer()
        }.padding().navigationTitle("FlaggedMessagesTab") } }