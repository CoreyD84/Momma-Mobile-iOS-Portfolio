    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                Text("MommaDeviceAdmin").font(.title2).bold().padding(.bottom)
                Button(action: {}) {
                    HStack { Text("MommaDeviceAdmin"); Spacer(); Image(systemName: "chevron.right.circle") }
                ...
                Button(action: {}) {
                    HStack { Text("disabled"); Spacer(); Image(systemName: "chevron.right.circle") }
                    .padding().background(Color.blue.opacity(0.1)).cornerRadius(8)
                }
                Button(action: {}) {
