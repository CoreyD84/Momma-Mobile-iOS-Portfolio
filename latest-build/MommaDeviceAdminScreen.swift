    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                ...
                Text("⚠️ Child is attempting to disable Device Admin!").font(.subheadline).foregroundColor(.secondary)
                Text("⚠️ Disabling this will alert your guardian and may violate your safety agreement.").font(.subheadline).foregroundColor(.secondary)
                Button(action: {}) {
                    HStack {
                        Text("guardian_id")
                        Spacer()
