    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                ...
                Button(action: {}) {
                    HStack { Text("📝 No notes added."); Spacer(); Image(systemName: "chevron.right.circle") }
                    .padding().background(Color.blue.opacity(0.1)).cornerRadius(8)
                }
                Button(action: {}) {
                    HStack { Text("🚨 Escalated"); Spacer(); Image(systemName: "chevron.right.circle") }
                    .padding().background(Color.blue.opacity(0.1)).cornerRadius(8)
                }
                Button(action: {}) {
                    HStack { Text("Action"); Spacer(); Image(systemName: "chevron.right.circle") }
                ...
                Button(action: {}) {
                    HStack { Text("🛡️ Deflection: \\"); Spacer(); Image(systemName: "chevron.right.circle") }
                    .padding().background(Color.blue.opacity(0.1)).cornerRadius(8)
                }
            }.padding()
        }
