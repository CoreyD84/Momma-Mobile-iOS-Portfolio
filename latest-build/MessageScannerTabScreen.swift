    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                Text("MessageScannerTab").font(.title2).bold().padding(.bottom)
                Button(action: {}) {
                    HStack { Text("MessageScannerTab"); Spacer(); Image(systemName: "chevron.right.circle") }
                ...
                Button(action: {}) {
                    HStack { Text("Scan"); Spacer(); Image(systemName: "chevron.right.circle") }
                    .padding().background(Color.blue.opacity(0.1)).cornerRadius(8)
                }
                Button(action: {}) {
                    HStack { Text("Action"); Spacer(); Image(systemName: "chevron.right.circle") }
