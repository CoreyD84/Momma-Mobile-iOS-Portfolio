...
struct StatCardScreen: View {
    @EnvironmentObject var container: AppDependencyContainer
    @StateObject private var viewModel: StatCardViewModel

    init(viewModel: StatCardViewModel? = nil) {
        _viewModel = StateObject(wrappedValue: viewModel ?? StatCardViewModel())
    }
